...
{ text = (text ? text " " : "") $0; }
END{printp(par);for(;nl>0;nl--){if(match(block[nl],/[ou]l/))oprint("</li>");oprint("</" block[nl] ">");}gsub(/\n/,"",otext);oprint("<br><a href=../>back</a>");printf(otext);}
